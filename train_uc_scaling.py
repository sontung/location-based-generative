...
from models import LocationBasedGenerator, LocationBasedGeneratorWithScaling
...
PARSER.add_argument("--dir", help="train directory",
                    default="/home/sontung/thesis/photorealistic-blocksworld/blocks-5-3-scaling", type=str)
PARSER.add_argument("--eval_dir", help="2nd domain evaluation directory",
                    default="/home/sontung/thesis/photorealistic-blocksworld/blocks-6-3-scaling", type=str)
